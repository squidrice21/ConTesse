...
struct Order{
    bool operator() (const Segment& a, const Segment& b) const {
        ...
        auto left_is_higher = [&](const Segment& seg1, const Segment& seg2){
            Eigen::Vector2d al {std::get<0>(std::get<0>(seg1)), std::get<1>(std::get<0>(seg1))};
            Eigen::Vector2d ar {std::get<0>(std::get<1>(seg1)), std::get<1>(std::get<1>(seg1))};
            Eigen::Vector2d bl {std::get<0>(std::get<0>(seg2)), std::get<1>(std::get<0>(seg2))};
            Eigen::Vector2d br {std::get<0>(std::get<1>(seg2)), std::get<1>(std::get<1>(seg2))};
            double pred = static_cast<double>(igl::predicates::orient2d(al,ar,bl));
            if(pred < 0) {
                return false;
            }
            if(pred > 0) {
        ...
        if(std::get<0>(a0) != std::get<0>(b0)){
            ...
            if(std::get<1>(a0) == std::get<1>(b0)){ // or use vertex id
                Eigen::Vector2d al {std::get<0>(std::get<0>(a)), std::get<1>(std::get<0>(a))};
                Eigen::Vector2d ar {std::get<0>(std::get<1>(a)), std::get<1>(std::get<1>(a))};
                Eigen::Vector2d bl {std::get<0>(std::get<0>(b)), std::get<1>(std::get<0>(b))};
                Eigen::Vector2d br {std::get<0>(std::get<1>(b)), std::get<1>(std::get<1>(b))};
                double pred = static_cast<double>(igl::predicates::orient2d(al,ar,bl));
                if(pred < 0) {
                    return false;
                }
...
bool disjoint_segment_intersect(
    ...
    Eigen::Vector2d a {std::get<0>(std::get<0>(s1)),std::get<1>(std::get<0>(s1))};
    Eigen::Vector2d b {std::get<0>(std::get<1>(s1)),std::get<1>(std::get<1>(s1))};
    Eigen::Vector2d c {std::get<0>(std::get<0>(s2)),std::get<1>(std::get<0>(s2))};
    Eigen::Vector2d d {std::get<0>(std::get<1>(s2)),std::get<1>(std::get<1>(s2))};
...
bool is_simple_polygon(const Eigen::MatrixXd& P){
    ...
    while(!Q.empty()){
        ...
        // UNUSED: int seg_id = std::get<2>(seg);
        if(is_enter){
            sl.insert(seg);
