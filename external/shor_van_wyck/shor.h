...
// If you want to use the logger in shor, I think the easiest is to just
// move it to the src folder. 
// Otherwise, shor can have its own spdlog::logger() object.
...
struct Angle
{
  ...
  Angle operator+(Angle K){
    ...
    double ori1 = orientation(tri1);
    double ori2 = orientation(tri2);
