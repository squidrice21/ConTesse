...
class Vec2f
{
 public:
    ...
    Vec2f(double x, double y) { p[0]=x; p[1]=y; }
    Vec2f(const double *f) { p[0]=f[0]; p[1]=f[1]; }
    Vec2f(double *d) { p[0]=d[0]; p[1]=d[1]; }
    Vec2f(const Vec2f& v) { p[0]=v.p[0]; p[1]=v.p[1]; }
    inline void setValue(double x, double y) { p[0]=x; p[1]=y; }
    inline double* getValue() { return p; }
    inline void set(double *f) { p[0]=f[0]; p[1]=f[1]; }
    inline void scale(double s) { p[0]*=s; p[1]*=s; }
    ...
    bool equals(const Vec2f &v, double tol) const
...
class Vec3f
{
 public:
    ...
    Vec3f(double x, double y, double z) { p[0]=x; p[1]=y; p[2]=z; }
    Vec3f(const double *f) { p[0]=f[0]; p[1]=f[1]; p[2]=f[2]; }
    Vec3f(double *d) { p[0]=d[0]; p[1]=d[1]; p[2]=d[2]; }
    Vec3f(const Vec3f& v) { p[0]=v.p[0]; p[1]=v.p[1]; p[2]=v.p[2];}
    inline void setValue(double x, double y, double z) { p[0]=x; p[1]=y; p[2]=z; }
    inline double* getValue() { return p; }
    inline void set(double *f) { p[0]=f[0]; p[1]=f[1]; p[2]=f[2]; }
    inline void scale(double s) { p[0]*=s; p[1]*=s; p[2]*=s; }
    ...
    bool equals(const Vec3f &v, double tol) const
    ...
    { return Vec3f(p[1]*v.p[2] - p[2]*v.p[1],
		   p[2]*v.p[0] - p[0]*v.p[2],
		   p[0]*v.p[1] - p[1]*v.p[0]); }
    void rotateXY(double theta, double tx, double ty);
};
...
class Vec4f
{
 ...
 public:
    ...
    Vec4f(double x, double y, double z, double w) { p[0]=x; p[1]=y; p[2]=z; p[3]=w; }
    Vec4f(const double *f) { p[0]=f[0]; p[1]=f[1]; p[2]=f[2]; p[3]=f[3]; }
    Vec4f(double *d) { p[0]=d[0]; p[1]=d[1]; p[2]=d[2]; p[3]=d[3]; }
    Vec4f(const Vec4f& v) { p[0]=v.p[0]; p[1]=v.p[1]; p[2]=v.p[2]; p[3]=v.p[3];}
    inline void setValue(double x, double y, double z, double w) { p[0]=x; p[1]=y; p[2]=z; p[3]=w; }
    inline double* getValue() { return p; }
    inline void set(double *f) { p[0]=f[0]; p[1]=f[1]; p[2]=f[2]; p[3]=f[3]; }
    inline void scale(double s) { p[0]*=s; p[1]*=s; p[2]*=s; }
    ...
    inline double& operator[](int n) { return p[n]; }
    ...
    bool equals(const Vec4f &v, double tol)
    { return fabs(p[0]-v.p[0])<tol
            && fabs(p[1]-v.p[1])<tol
            && fabs(p[2]-v.p[2])<tol
            && fabs(p[3]-v.p[3])<tol; }
...
class Rotation
{
 public:
    ...
    Rotation(const double v[4]) { setValue(v); }
    ...
    Rotation(const Vec3f &axis, double radians)
    ...
    const double	* getValue() const { return (quat); }

    // Returns 4 individual components of rotation quaternion 
    void getValue(double &q0, double &q1, double &q2, double &q3) const;

    // Returns corresponding 3D rotation axis vector and angle in radians
    void getValue(Vec3f &axis, double &radians) const;
    ...
    Rotation& setValue(const Vec3f &axis, double radians);
